...
userlog(studentRegno,userip,status)
...
<marquee direction='up' scrollamount="2" onmouseover="this.stop();" o
nmouseout="this.start();">
<ul>
<?php
...
htmlentities($row['newstitle']);?>-<?php echo
htmlentities($row['postingDate']);?></a>
</li>
<?php } ?>
</ul>
</marquee>
